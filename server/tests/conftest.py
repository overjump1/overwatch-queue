...
directory, those servers loaded the real Firebase service account, push relay and device
tokens — and every phase change a test drove went out as a real push to a real phone and
watch. Redirecting the home directory here, before any test module imports `owqserver`,
